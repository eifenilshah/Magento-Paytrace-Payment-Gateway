 ...
 *
 */
class MP_Paytrace_Model_Revolution extends Mage_Paygate_Model_Authorizenet
{
    /**
     * 
     * @var unknown
     ...
     * @var unknown
     */
    const METHOD_CODE = 'mp_paytrace';
    
    /**
     * 
     * @var unknown
     */
    protected $_code  = 'mp_paytrace';
...
//    public function getDebugFlag(){return true;}
    ...
    protected function _buildRequest(Varien_Object $payment)
    {
        ...
        if (!empty($order)) {
            ...
            if (Mage::helper('mp_paytrace')->isLevel3Enabled())
            {
	            /*
