...
/**
 * 
 * Class gives you the ability to edit your payment methods from the MY Account screen.
 * @author anonymous
 *
 */
class MP_Paytrace_Block_Account_Card_Edit extends Mage_Core_Block_Template
{
    /**
     * 
     * @return type
